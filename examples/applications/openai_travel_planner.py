...
def main():
    ...
    print(f"A complete travel planning system powered by OpenAI {args.model}")
    ...
    class TravelPlanner(A2AServer):
        ...
        """
        def __init__(self, knowledge_base, openai_model):
    ...
    travel_planner = TravelPlanner(kb, args.model)
